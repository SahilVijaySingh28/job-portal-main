...
function AddJobPage({ addJob, role, userEmail, onLogout }){
    if (role !== 'admin') {
        return <div className="p-10 text-center text-red-500 font-bold">Access denied. Only admin can add jobs.</div>;
    }
    return (
